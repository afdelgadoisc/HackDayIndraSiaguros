...
export class GeminiAgent{
    ...
    async initialize() {
        try {            
            ...
            this.client.sendText('Saludame en español, presentante como un asistente llamado sIAguro espacializado en seguros que puede responder todo lo que el cliente le diga por comandos de voz');  // Trigger the model to start speaking first
        } catch (error) {
